...
# Fun��o respons�vel por  split
def _split(line: str) -> List[str]:
    return [p.strip() for p in line.split(";")]

# Fun��o respons�vel por criar trelica de dados
...
# Fun��o respons�vel por carregar entrada
...
# Fun��o respons�vel por carregar entrada from stream
...
# Fun��o respons�vel por resolver trelica from stream
...
# Fun��o respons�vel por resolver trelica
...
# Fun��o respons�vel por imprimir saida formatada
